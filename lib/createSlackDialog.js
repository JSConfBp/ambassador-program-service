 ...
 * @param {*} [options={}]
 */
module.exports = async function (id, response_url, trigger_id, code, options = {}, channel, message_ts) {
   	const {
	   title,
	   submit_label
   	} = options

	console.log('createSlackDialog', {id, response_url, trigger_id, code, options, channel});
